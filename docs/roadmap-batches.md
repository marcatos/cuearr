...
| View | What it shows |
|------|----------------|
| [Active now](https://github.com/users/marcatos/projects/1/views/4) | `batch:b2` + `batch:b6` |
...
| [Queued later](https://github.com/users/marcatos/projects/1/views/5) | B3–B5 |
...
1. **B2** — File reliability (`batch:b2`) — see [`file-reliability.md`](file-reliability.md)  
2. **B6** — Competitive experiment (`batch:b6`, measurement/docs only)  

**Completed:** **B1** — Prove the promise (`batch:b1`).

## Work order inside B2
