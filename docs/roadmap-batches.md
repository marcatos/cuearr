...
| View | What it shows |
|------|----------------|
| [Active now](https://github.com/users/marcatos/projects/1/views/4) | `batch:b3` + `batch:b6` |
...
1. **B3** — Assisted beta (`batch:b3`) — see [`beta.md`](beta.md)  
2. **B6** — Competitive experiment (`batch:b6`, measurement/docs only)  

**Completed:** **B1** — Prove the promise (`batch:b1`); **B2** — File reliability (`batch:b2`).

## Work order inside B3
